...
When we have a very large number of covariates that are independent of the treatment groups, we want to use the Lasso algorithm to use the best covariates that affect our treatment groups. 
